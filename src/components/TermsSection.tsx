...
export default function TermsSection() {
  return (
    <section id="terms" className="py-12 md:py-20 lg:py-32 bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 overflow-hidden relative">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 border border-white/20 rounded-full px-4 md:px-6 py-2 md:py-3 mb-4 md:mb-6 backdrop-blur-xl">
              <Shield className="w-4 h-4 md:w-5 md:h-5 text-yellow-400 animate-pulse" />
              <span className="text-white font-semibold text-sm md:text-base">Professional Standards</span>
            </div>
          ...
          {/* Main Terms Grid */}
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16 lg:mb-20">
            {termsItems.map((item, index) => {
              ...
              return (
                ...
                >
                  {/* Glow Effect */}
                  <div className={`absolute inset-0 bg-gradient-to-br ${item.color} opacity-0 group-hover:opacity-20 blur-xl rounded-2xl md:rounded-3xl transition-all duration-500`} />
                  
                  <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-3xl p-6 md:p-8 hover:bg-white/10 hover:border-white/30 transition-all duration-500 hover:-translate-y-2 shadow-2xl h-full">
                    <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
                      <div className={`w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center group-hover:scale-110 group-hover:rotate-12 transition-all shadow-2xl`}>
                        <Icon className="w-6 h-6 md:w-8 md:h-8 text-white" />
                      </div>
                      <h3 className="text-xl md:text-2xl font-bold text-white">{item.title}</h3>
                    </div>
                    
                    <p className="text-sm md:text-base text-slate-300 leading-relaxed mb-4 md:mb-6">{item.content}</p>
                    
                    <div className="flex flex-wrap gap-2 pt-4 border-t border-white/10">
                      {item.highlights.map((highlight, idx) => (
                        <span key={idx} className="px-3 py-1 bg-white/10 text-white text-xs md:text-sm rounded-lg border border-white/20 flex items-center gap-1">
          ...
          <div className="relative bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 rounded-2xl md:rounded-3xl p-8 md:p-12 lg:p-16 border border-white/20 backdrop-blur-xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute inset-0 overflow-hidden opacity-5">
              ...
              <Shield className="absolute top-20 right-20 w-16 h-16 md:w-20 md:h-20 animate-pulse" style={{ animationDelay: '1s' }} />
              <Heart className="absolute bottom-10 left-20 w-14 h-14 md:w-18 md:h-18 animate-pulse" style={{ animationDelay: '2s' }} />
              <Zap className="absolute bottom-20 right-10 w-12 h-12 md:w-16 md:h-16 animate-pulse" style={{ animationDelay: '1.5s' }} />
            </div>
            
            <div className="relative z-10 text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-pink-500 to-rose-500 mb-4 md:mb-6 shadow-2xl">
                <Heart className="w-8 h-8 md:w-10 md:h-10 text-white animate-pulse" />
              </div>
              <h3 className="text-3xl md:text-4xl lg:text-5xl font-black mb-3 md:mb-4 text-white">Thank You for Your Trust</h3>
              <p className="text-xl md:text-2xl font-bold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent mb-3 md:mb-4">
                Samuel A. Emoni - Graphic Design & Web Solutions
              </p>
              <p className="text-base md:text-lg text-slate-300 max-w-2xl mx-auto mb-6 md:mb-8">
              ...
              <div className="flex flex-wrap justify-center gap-2 md:gap-3">
                <span className="px-4 md:px-5 py-2 bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 rounded-full text-xs md:text-sm font-semibold flex items-center gap-2">
                  <Sparkles className="w-3 h-3 md:w-4 md:h-4" />
                  Professional Quality
                </span>
                <span className="px-4 md:px-5 py-2 bg-purple-500/20 text-purple-300 border border-purple-500/30 rounded-full text-xs md:text-sm font-semibold flex items-center gap-2">
                  <Shield className="w-3 h-3 md:w-4 md:h-4" />
                  Secure & Confidential
                </span>
                <span className="px-4 md:px-5 py-2 bg-pink-500/20 text-pink-300 border border-pink-500/30 rounded-full text-xs md:text-sm font-semibold flex items-center gap-2">
